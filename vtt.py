...
def offend():
    ...
    if(r==0):
        say("Yo momma is so fat, I took a picture of her last Christmas and it's still printing.")
    elif(r==2):
        say("Yo momma is so fat when she got on the scale it said, \"I need your weight not your phone number.")
    elif(r==3):
        say("Yo momma is so fat that Dora can't even explore her!")
    elif(r==4):
        say("Yo momma's so fat and old when God said, \"Let there be light,\" he asked your mother to move out of the way.")
    elif(r==5):
        say("Yo momma is so fat when she sat on WalMart, she lowered the prices.")
...
while(True):
    ...
    if(recognized_audio != None):
        if( "play" in recognized_audio and "music" in recognized_audio):
            ...
            record(10)
        elif("offend" in recognized_audio):
            offend()
            say("boom bitch! hahahahahahahaha!")
